...
## Type: String
# c.downloads.open_dispatcher = handlr open {}
...
c.spellcheck.languages = ['en-US', 'es-ES', 'fr-FR']
...
c.url.searchengines = {
        ...
        # l: https://www.google.com/search?btnI=I'm+Feeling+Lucky&q={},
        'o': 'https://search.nixos.org/options?channel=unstable&from=0&size=50&sort=relevance&type=packages&query={}',
        'p': 'https://search.nixos.org/packages?channel=unstable&size=50&sort=relevance&type=packages&query={}',
        # ra: http://dle.rae.es/?w={},
        # so: http://stackoverflow.com/search?q={},
        # su: http://superuser.com/search?q={},
