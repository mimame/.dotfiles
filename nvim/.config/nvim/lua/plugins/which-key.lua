...
wk.register({
  b = {
    ...
    l = { '<cmd>BufferLineCycleNext<cr>', 'Go to the next buffer' },
    h = { '<cmd>BufferLineCyclePrev<cr>', 'Go to the previous buffer' },
...
wk.register({
  g = {
    ...
    b = { '<cmd>lua require"gitsigns.actions".blame_line({full = true})<cr>', 'Git blame line' },
    B = { '<cmd>Telescope git_branches<cr>', 'Git Branches' },
    S = { '<cmd>Telescope git_status<cr>', 'Git status' },
    j = { '<cmd>lua require"gitsigns.actions".next_hunk()<cr>', 'Go to the next hunk' },
    k = { '<cmd>lua require"gitsigns.actions".prev_hunk()<cr>', 'Go to the previous hunk' },
    s = { '<cmd>lua require"gitsigns.actions".stage_hunk()<cr>', 'Stage hunk' },
    u = { '<cmd>lua require"gitsigns.actions".reset_hunk()<cr>', 'Undo hunk' },
    r = { '<cmd>lua require"gitsigns.actions".undo_stage_hunk()<cr>', 'Undo staged hunk' },
...
wk.register({
  f = {
    ...
    n = { '<cmd>lua require"nvim-tree".toggle(true, true)<CR>', 'NvimTree' },
