...
-- s for substitute {{{
map('n', 'gs', '<plug>(SubversiveSubstitute)', { noremap = false })
map('n', 'gss', '<plug>(SubversiveSubstituteLine)', { noremap = false })
map('n', 'gS', '<plug>(SubversiveSubstituteToEndOfLine)', { noremap = false })
-- }}}
